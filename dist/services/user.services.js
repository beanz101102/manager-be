...
class UserServices {
    ...
    static getListUser(role_1, text_1, departmentId_1) {
        return __awaiter(this, arguments, void 0, function* (role, text, departmentId, page = 1, limit = 10) {
            const skip = (page - 1) * limit;
            let whereConditions = { role };
            if (departmentId) {
                whereConditions.department = { id: departmentId };
            }
            if (text) {
                whereConditions = [
                    { fullName: (0, typeorm_1.Like)(`%${text}%`), role },
                    { code: (0, typeorm_1.Like)(`%${text}%`), role },
                ];
            }
    ...
    static deleteUser(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield userRepo.delete(ids);
            return result;
        });
    }
}
