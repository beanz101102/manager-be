...
class contractController {
    ...
    getCancelledContractsInTimeRange(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield contract_services_1.default.getCancelledContractsInTimeRange(start, end);
                return res.status(200).json({
                    success: true,
                    data: result,
                });
    ...
    getContractsInTimeRange(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield contract_services_1.default.getContractsInTimeRange(start, end, status);
                return res.status(200).json({
                    success: true,
                    data: result,
                });
    ...
    getCustomerContractReport(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const report = yield contract_services_1.default.getCustomerContractReport();
                return res.status(200).json({
                    success: true,
                    data: report,
                });
    ...
    getAdvancedStatistics(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { startTime, endTime, status, createdById, customerId } = req.query;
                const result = yield contract_services_1.default.getAdvancedStatistics({
